...
// Scroll through the full page height to trigger all IntersectionObserver callbacks
...
// Wait for all transitions to complete (max delay 0.4s + transition 0.6s = 1s)
